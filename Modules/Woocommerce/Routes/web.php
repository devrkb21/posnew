...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('woocommerce')->group(function () {
    ...
    Route::get('/import-categories', [Modules\Woocommerce\Http\Controllers\WoocommerceController::class, 'importCategories']);
    Route::get('/import-products', [Modules\Woocommerce\Http\Controllers\WoocommerceController::class, 'importProducts']);
    Route::get('/import-orders', [Modules\Woocommerce\Http\Controllers\WoocommerceController::class, 'importOrders']);
    Route::get('/fix-missing-variations', [Modules\Woocommerce\Http\Controllers\WoocommerceController::class, 'fixMissingVariations']);
    Route::get('/fix-customer-data', [Modules\Woocommerce\Http\Controllers\WoocommerceController::class, 'fixCustomerData']);
